...
class Select_Calc_Page(CTkFrame):
    def __init__(self, root):
        ...
        button_1 = CTkButton(master=container, text="Equation", fg_color="#4e1d58", hover_color="#370d40",
                             text_color="#DDC3C3", font=("Helvetica", 40, "bold"),width=400,
                             height=100, corner_radius=25, command=lambda: root.slide_to_page("select_eq", direction="left"))
        button_1.grid(row=0, column=0, padx=30)

        button_2 = CTkButton(master=container, text="Calculator", fg_color="#4e1d58", hover_color="#370d40",
                             text_color="#DDC3C3", font=("Helvetica", 40, "bold"),width=400,
                             height=100, corner_radius=25, command=lambda: root.slide_to_page("operation", direction="left"))
